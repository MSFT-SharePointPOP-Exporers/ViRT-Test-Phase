                       ...
                       $(".dchm").append('<ul class="small-block-grid-2 medium-block-grid-3 large-block-grid-4">');
                        if (data != null) {
                            for (var x = 0; x < data.length; x++) {
                                ...
                                $("#" + x).append("<h2>Network " + data[x].NetworkID + "<br/><a href='#' onClick='setNetwork(" + data[x].NetworkID + ")'>" + data[x].Percentage.toFixed(4) + "%</a></h2>");
                                ...
                                for (var y = 0; y < data[x].Farms.length; y++) {
                                    if (data[x].Farms[y].Percentage <= 100.00 && data[x].Farms[y].Percentage >= 99.9) {
                                        $("#" + data[x].NetworkID).append("<div class ='farm-box green' onClick='setFarm(this.id)' id=" + data[x].Farms[y].Farms + ">Farm " + data[x].Farms[y].Farms.toString() + "<br/>" + data[x].Farms[y].Percentage.toFixed(4) + "%</div>");
                                    } else if (data[x].Farms[y].Percentage < 99.9 & data[x].Farms[y].Percentage >= 99.0) {
                                        $("#" + data[x].NetworkID).append("<div class ='farm-box yellow' onClick='setFarm(this.id)' id=" + data[x].Farms[y].Farms + ">Farm " + data[x].Farms[y].Farms.toString() + "<br/>" + data[x].Farms[y].Percentage.toFixed(4) + "%</div>");
                                    } else if (data[x].Farms[y].Percentage < 99.0 && data[x].Farms[y].Percentage >= 95.0) {
                                        $("#" + data[x].NetworkID).append("<div class ='farm-box red1' onClick='setFarm(this.id)' id=" + data[x].Farms[y].Farms + ">Farm " + data[x].Farms[y].Farms.toString() + "<br/>" + data[x].Farms[y].Percentage.toFixed(4) + "%</div>");
                                    } else if (data[x].Farms[y].Percentage < 95.0 && data[x].Farms[y].Percentage >= 85.0) {
                                        $("#" + data[x].NetworkID).append("<div class ='farm-box red2' onClick='setFarm(this.id)' id=" + data[x].Farms[y].Farms + ">Farm " + data[x].Farms[y].Farms.toString() + "<br/>" + data[x].Farms[y].Percentage.toFixed(4) + "%</div>");
                                    } else {
                                        $("#" + data[x].NetworkID).append("<div class ='farm-box red3' onClick='setFarm(this.id)' id=" + data[x].Farms[y].Farms + ">Farm " + data[x].Farms[y].Farms.toString() + "<br/>" + data[x].Farms[y].Percentage.toFixed(4) + "%</div>");
                                    }
                                }
                            }
                        }
